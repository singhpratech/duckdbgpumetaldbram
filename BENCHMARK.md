...
## v0.7 key joins through the transparent path — Metal, TPC-H SF1 and SF10 (2026-09-17)

Plain `JOIN` SQL through `gpudb.connect()` (docs/TRANSPARENT_DESIGN.md §4.8):
the wrapper lowers the join, keeps one exact set per base table resident,
materialises the join on the device once (`gpu_join_materialize`; SF1
lineitem x orders, 6.0M x 1.5M rows, four lanes: 12 ms warm) and answers the
statement from the joined set. Apple M4 Max, `scripts/transparent_gate.py`,
statement vs statement in one process, warm, rows identical to native on
every line, min of N.

### SF1 (N=5, thresholds on — the shipping configuration)

| join: key | WHERE | selectivity | form | rows out | native ms | transparent ms | ratio | result |
|---|---|---|---|---|---|---|---|---|
| li x orders: o_custkey | — | 100% | plain | 99996 | 70.3 | 55.7 | 1.26× | PASS |
| li x orders: o_custkey | — | 100% | having | 999 | 17.9 | 2.5 | 7.24× | PASS |
| li x orders: o_custkey | — | 100% | topk | 10 | 18.2 | 4.5 | 4.03× | PASS |
| li x orders: o_orderdate | — | 100% | plain | 2406 | 11.3 | 3.2 | 3.52× | PASS |
| li x orders: o_orderdate | — | 100% | having | 25 | 9.6 | 2.1 | 4.48× | PASS |
| li x orders: o_orderdate | — | 100% | topk | 10 | 9.4 | 3.5 | 2.70× | PASS |
| li x orders: l_suppkey | — | 100% | plain | 10000 | 19.0 | 7.9 | 2.40× | PASS |
| li x orders: l_suppkey | — | 100% | having | 100 | 13.3 | 2.5 | 5.33× | PASS |
| li x orders: l_suppkey | — | 100% | topk | 10 | 13.5 | 2.6 | 5.20× | PASS |
| li x orders: o_custkey | o_orderdate < DATE '1995-03-15' | 49% | plain | 99606 | 64.5 | 58.1 | 1.11× | PASS |
| li x orders: o_custkey | o_orderdate < DATE '1995-03-15' | 49% | having | 992 | 13.4 | 3.3 | 4.05× | PASS |
| li x orders: o_custkey | o_orderdate < DATE '1995-03-15' | 49% | topk | 10 | 12.9 | 5.6 | 2.32× | PASS |
| li x orders: o_orderdate | o_orderdate < DATE '1995-03-15' | 49% | plain | 1169 | 10.2 | 3.0 | 3.38× | PASS |
| li x orders: o_orderdate | o_orderdate < DATE '1995-03-15' | 49% | having | 12 | 9.3 | 2.6 | 3.56× | PASS |
| li x orders: o_orderdate | o_orderdate < DATE '1995-03-15' | 49% | topk | 10 | 9.2 | 2.4 | 3.88× | PASS |
| li x orders: l_suppkey | o_orderdate < DATE '1995-03-15' | 49% | plain | 10000 | 17.1 | 8.1 | 2.10× | PASS |
| li x orders: l_suppkey | o_orderdate < DATE '1995-03-15' | 49% | having | 100 | 11.6 | 2.9 | 3.96× | PASS |
| li x orders: l_suppkey | o_orderdate < DATE '1995-03-15' | 49% | topk | 10 | 11.8 | 3.9 | 3.03× | PASS |
| li x orders: o_custkey | o_orderdate >= DATE '1998-06-01' | 3% | plain | 31708 | 19.6 | — | — | declined (threshold) |
| li x orders: o_custkey | o_orderdate >= DATE '1998-06-01' | 3% | having | 317 | 4.3 | 2.4 | 1.81× | PASS |
| li x orders: o_custkey | o_orderdate >= DATE '1998-06-01' | 3% | topk | 10 | 4.2 | 2.8 | 1.49× | PASS |
| li x orders: o_orderdate | o_orderdate >= DATE '1998-06-01' | 3% | plain | 63 | 3.5 | 1.0 | 3.52× | PASS |
| li x orders: o_orderdate | o_orderdate >= DATE '1998-06-01' | 3% | having | 1 | 3.4 | 1.3 | 2.70× | PASS |
| li x orders: o_orderdate | o_orderdate >= DATE '1998-06-01' | 3% | topk | 10 | 3.4 | 0.9 | 3.75× | PASS |
| li x orders: l_suppkey | o_orderdate >= DATE '1998-06-01' | 3% | plain | 10000 | 9.4 | 9.0 | 1.05× | PASS |
| li x orders: l_suppkey | o_orderdate >= DATE '1998-06-01' | 3% | having | 98 | 4.5 | 2.3 | 1.96× | PASS |
| li x orders: l_suppkey | o_orderdate >= DATE '1998-06-01' | 3% | topk | 10 | 4.4 | 2.3 | 1.95× | PASS |
| li x orders: o_custkey | l_discount < 0.01 | 9% | plain | 97490 | 59.0 | 54.5 | 1.08× | PASS |
| li x orders: o_custkey | l_discount < 0.01 | 9% | having | 962 | 9.9 | 5.8 | 1.69× | PASS |
| li x orders: o_custkey | l_discount < 0.01 | 9% | topk | 10 | 9.5 | 5.1 | 1.87× | PASS |
| li x orders: o_orderdate | l_discount < 0.01 | 9% | plain | 2406 | 9.1 | 3.2 | 2.83× | PASS |
| li x orders: o_orderdate | l_discount < 0.01 | 9% | having | 25 | 8.2 | 2.3 | 3.50× | PASS |
| li x orders: o_orderdate | l_discount < 0.01 | 9% | topk | 10 | 7.9 | 2.2 | 3.65× | PASS |
| li x orders: l_suppkey | l_discount < 0.01 | 9% | plain | 10000 | 13.6 | 7.0 | 1.94× | PASS |
| li x orders: l_suppkey | l_discount < 0.01 | 9% | having | 99 | 9.0 | 2.4 | 3.78× | PASS |
| li x orders: l_suppkey | l_discount < 0.01 | 9% | topk | 10 | 8.5 | 4.8 | 1.76× | PASS |
| li x orders x customer: c_nationkey | — | 100% | plain | 25 | 12.5 | 2.8 | 4.45× | PASS |
| li x orders x customer: c_nationkey | — | 100% | having | 1 | 11.7 | 3.2 | 3.61× | PASS |
| li x orders x customer: c_nationkey | — | 100% | topk | 10 | 11.4 | 3.0 | 3.82× | PASS |
| li x orders x customer: c_custkey | — | 100% | plain | 99996 | 75.0 | 57.3 | 1.31× | PASS |
| li x orders x customer: c_custkey | — | 100% | having | 999 | 19.5 | 4.9 | 3.98× | PASS |
| li x orders x customer: c_custkey | — | 100% | topk | 10 | 19.0 | 4.4 | 4.30× | PASS |
| li x orders x customer: c_nationkey | o_orderdate < DATE '1995-03-15' | 49% | plain | 25 | 11.4 | 2.7 | 4.24× | PASS |
| li x orders x customer: c_nationkey | o_orderdate < DATE '1995-03-15' | 49% | having | 1 | 11.0 | 3.1 | 3.51× | PASS |
| li x orders x customer: c_nationkey | o_orderdate < DATE '1995-03-15' | 49% | topk | 10 | 11.1 | 6.9 | 1.61× | PASS |
| li x orders x customer: c_custkey | o_orderdate < DATE '1995-03-15' | 49% | plain | 99606 | 65.5 | 58.0 | 1.13× | PASS |
| li x orders x customer: c_custkey | o_orderdate < DATE '1995-03-15' | 49% | having | 992 | 14.9 | 3.5 | 4.25× | PASS |
| li x orders x customer: c_custkey | o_orderdate < DATE '1995-03-15' | 49% | topk | 10 | 14.4 | 5.5 | 2.60× | PASS |
| li x orders x customer: c_nationkey | o_orderdate >= DATE '1998-06-01' | 3% | plain | 25 | 5.0 | 3.6 | 1.38× | PASS |
| li x orders x customer: c_nationkey | o_orderdate >= DATE '1998-06-01' | 3% | having | 1 | 5.1 | 4.9 | 1.04× | PASS |
| li x orders x customer: c_nationkey | o_orderdate >= DATE '1998-06-01' | 3% | topk | 10 | 5.1 | 2.1 | 2.47× | PASS |
| li x orders x customer: c_custkey | o_orderdate >= DATE '1998-06-01' | 3% | plain | 31708 | 20.9 | — | — | declined (threshold) |
| li x orders x customer: c_custkey | o_orderdate >= DATE '1998-06-01' | 3% | having | 317 | 5.7 | 2.5 | 2.25× | PASS |
| li x orders x customer: c_custkey | o_orderdate >= DATE '1998-06-01' | 3% | topk | 10 | 5.6 | 2.9 | 1.91× | PASS |
| li x orders x customer: c_nationkey | l_discount < 0.01 | 9% | plain | 25 | 8.3 | 2.2 | 3.83× | PASS |
| li x orders x customer: c_nationkey | l_discount < 0.01 | 9% | having | 1 | 8.1 | 2.9 | 2.75× | PASS |
| li x orders x customer: c_nationkey | l_discount < 0.01 | 9% | topk | 10 | 8.2 | 4.7 | 1.73× | PASS |
| li x orders x customer: c_custkey | l_discount < 0.01 | 9% | plain | 97490 | 59.8 | 54.5 | 1.10× | PASS |
| li x orders x customer: c_custkey | l_discount < 0.01 | 9% | having | 962 | 10.5 | 5.8 | 1.81× | PASS |
| li x orders x customer: c_custkey | l_discount < 0.01 | 9% | topk | 10 | 9.9 | 5.6 | 1.77× | PASS |
| li x part: p_brand | — | 100% | plain | 25 | 7.8 | 3.2 | 2.46× | PASS |
| li x part: p_brand | — | 100% | having | 1 | 7.6 | 3.7 | 2.06× | PASS |
| li x part: p_brand | — | 100% | topk | 10 | 7.7 | 4.1 | 1.87× | PASS |
| li x part: p_size | — | 100% | plain | 50 | 4.2 | 2.6 | 1.63× | PASS |
| li x part: p_size | — | 100% | having | 1 | 4.0 | 2.9 | 1.37× | PASS |
| li x part: p_size | — | 100% | topk | 10 | 4.0 | 2.6 | 1.53× | PASS |
| li x part: p_brand | l_discount < 0.01 | 9% | plain | 25 | 4.5 | 2.1 | 2.13× | PASS |
| li x part: p_brand | l_discount < 0.01 | 9% | having | 1 | 4.6 | 2.7 | 1.66× | PASS |
| li x part: p_brand | l_discount < 0.01 | 9% | topk | 10 | 4.5 | 2.7 | 1.65× | PASS |
| li x part: p_size | l_discount < 0.01 | 9% | plain | 50 | 3.4 | 2.0 | 1.69× | PASS |
| li x part: p_size | l_discount < 0.01 | 9% | having | 1 | 3.4 | 2.4 | 1.45× | PASS |
| li x part: p_size | l_discount < 0.01 | 9% | topk | 10 | 3.4 | 2.5 | 1.36× | PASS |
| li x part: p_brand | p_size <= 10 AND l_linenumber <= 3 | 13% | plain | 25 | 4.5 | 2.4 | 1.88× | PASS |
| li x part: p_brand | p_size <= 10 AND l_linenumber <= 3 | 13% | having | 1 | 4.5 | 2.9 | 1.53× | PASS |
| li x part: p_brand | p_size <= 10 AND l_linenumber <= 3 | 13% | topk | 10 | 4.6 | 4.0 | 1.17× | PASS |
| li x part: p_size | p_size <= 10 AND l_linenumber <= 3 | 13% | plain | 10 | 3.7 | 2.2 | 1.69× | PASS |
| li x part: p_size | p_size <= 10 AND l_linenumber <= 3 | 13% | having | 1 | 3.7 | 2.0 | 1.83× | PASS |
| li x part: p_size | p_size <= 10 AND l_linenumber <= 3 | 13% | topk | 10 | 3.7 | 2.0 | 1.86× | PASS |

### SF10 (59,986,052 x 15,000,000 rows; N=3, thresholds off — every shape the engine accepts)

| join: key | WHERE | selectivity | form | rows out | native ms | transparent ms | ratio | result |
|---|---|---|---|---|---|---|---|---|
| li x orders: o_custkey | — | 100% | plain | 999982 | 655.8 | 537.0 | 1.22× | PASS |
| li x orders: o_custkey | — | 100% | having | 9994 | 152.8 | 18.1 | 8.46× | PASS |
| li x orders: o_custkey | — | 100% | topk | 10 | 146.1 | 17.1 | 8.53× | PASS |
| li x orders: o_orderdate | — | 100% | plain | 2406 | 92.2 | 14.2 | 6.47× | PASS |
| li x orders: o_orderdate | — | 100% | having | 25 | 85.2 | 13.5 | 6.30× | PASS |
| li x orders: o_orderdate | — | 100% | topk | 10 | 85.5 | 13.0 | 6.56× | PASS |
| li x orders: l_suppkey | — | 100% | plain | 100000 | 233.3 | 74.2 | 3.14× | PASS |
| li x orders: l_suppkey | — | 100% | having | 997 | 170.7 | 21.6 | 7.91× | PASS |
| li x orders: l_suppkey | — | 100% | topk | 10 | 171.2 | 23.8 | 7.19× | PASS |
| li x orders: o_custkey | o_orderdate < DATE '1995-03-15' | 49% | plain | 996205 | 629.4 | 548.1 | 1.15× | PASS |
| li x orders: o_custkey | o_orderdate < DATE '1995-03-15' | 49% | having | 9961 | 107.6 | 24.1 | 4.46× | PASS |
| li x orders: o_custkey | o_orderdate < DATE '1995-03-15' | 49% | topk | 10 | 103.6 | 23.0 | 4.50× | PASS |
| li x orders: o_orderdate | o_orderdate < DATE '1995-03-15' | 49% | plain | 1169 | 69.7 | 7.8 | 8.99× | PASS |
| li x orders: o_orderdate | o_orderdate < DATE '1995-03-15' | 49% | having | 12 | 67.7 | 7.1 | 9.56× | PASS |
| li x orders: o_orderdate | o_orderdate < DATE '1995-03-15' | 49% | topk | 10 | 67.2 | 6.8 | 9.90× | PASS |
| li x orders: l_suppkey | o_orderdate < DATE '1995-03-15' | 49% | plain | 100000 | 183.3 | 81.8 | 2.24× | PASS |
| li x orders: l_suppkey | o_orderdate < DATE '1995-03-15' | 49% | having | 999 | 128.3 | 28.5 | 4.49× | PASS |
| li x orders: l_suppkey | o_orderdate < DATE '1995-03-15' | 49% | topk | 10 | 127.6 | 29.7 | 4.30× | PASS |
| li x orders: o_custkey | o_orderdate >= DATE '1998-06-01' | 3% | plain | 319607 | 200.8 | 179.5 | 1.12× | PASS |
| li x orders: o_custkey | o_orderdate >= DATE '1998-06-01' | 3% | having | 3161 | 34.7 | 14.5 | 2.39× | PASS |
| li x orders: o_custkey | o_orderdate >= DATE '1998-06-01' | 3% | topk | 10 | 32.7 | 15.3 | 2.14× | PASS |
| li x orders: o_orderdate | o_orderdate >= DATE '1998-06-01' | 3% | plain | 63 | 29.1 | 1.6 | 18.31× | PASS |
| li x orders: o_orderdate | o_orderdate >= DATE '1998-06-01' | 3% | having | 1 | 29.1 | 2.8 | 10.28× | PASS |
| li x orders: o_orderdate | o_orderdate >= DATE '1998-06-01' | 3% | topk | 10 | 28.9 | 2.3 | 12.70× | PASS |
| li x orders: l_suppkey | o_orderdate >= DATE '1998-06-01' | 3% | plain | 100000 | 88.5 | 68.0 | 1.30× | PASS |
| li x orders: l_suppkey | o_orderdate >= DATE '1998-06-01' | 3% | having | 996 | 37.6 | 16.6 | 2.27× | PASS |
| li x orders: l_suppkey | o_orderdate >= DATE '1998-06-01' | 3% | topk | 10 | 37.3 | 18.6 | 2.00× | PASS |
| li x orders: o_custkey | l_discount < 0.01 | 9% | plain | 975125 | 565.8 | 526.0 | 1.08× | PASS |
| li x orders: o_custkey | l_discount < 0.01 | 9% | having | 9689 | 65.9 | 19.0 | 3.48× | PASS |
| li x orders: o_custkey | l_discount < 0.01 | 9% | topk | 10 | 60.8 | 18.1 | 3.36× | PASS |
| li x orders: o_orderdate | l_discount < 0.01 | 9% | plain | 2406 | 45.7 | 14.9 | 3.07× | PASS |
| li x orders: o_orderdate | l_discount < 0.01 | 9% | having | 25 | 43.7 | 13.7 | 3.18× | PASS |
| li x orders: o_orderdate | l_discount < 0.01 | 9% | topk | 10 | 44.1 | 13.7 | 3.22× | PASS |
| li x orders: l_suppkey | l_discount < 0.01 | 9% | plain | 100000 | 123.6 | 70.5 | 1.75× | PASS |
| li x orders: l_suppkey | l_discount < 0.01 | 9% | having | 1000 | 69.7 | 18.3 | 3.80× | PASS |
| li x orders: l_suppkey | l_discount < 0.01 | 9% | topk | 10 | 68.5 | 20.2 | 3.39× | PASS |
| li x orders x customer: c_nationkey | — | 100% | plain | 25 | 117.0 | 25.4 | 4.60× | PASS |
| li x orders x customer: c_nationkey | — | 100% | having | 1 | 111.3 | 25.7 | 4.33× | PASS |
| li x orders x customer: c_nationkey | — | 100% | topk | 10 | 110.9 | 25.5 | 4.35× | PASS |
| li x orders x customer: c_custkey | — | 100% | plain | 999982 | 707.2 | 553.1 | 1.28× | PASS |
| li x orders x customer: c_custkey | — | 100% | having | 9994 | 174.6 | 19.5 | 8.95× | PASS |
| li x orders x customer: c_custkey | — | 100% | topk | 10 | 170.2 | 17.2 | 9.91× | PASS |
| li x orders x customer: c_nationkey | o_orderdate < DATE '1995-03-15' | 49% | plain | 25 | 86.9 | 23.9 | 3.64× | PASS |
| li x orders x customer: c_nationkey | o_orderdate < DATE '1995-03-15' | 49% | having | 1 | 92.0 | 24.0 | 3.83× | PASS |
| li x orders x customer: c_nationkey | o_orderdate < DATE '1995-03-15' | 49% | topk | 10 | 83.6 | 23.8 | 3.51× | PASS |
| li x orders x customer: c_custkey | o_orderdate < DATE '1995-03-15' | 49% | plain | 996205 | 657.0 | 552.5 | 1.19× | PASS |
| li x orders x customer: c_custkey | o_orderdate < DATE '1995-03-15' | 49% | having | 9961 | 121.6 | 24.5 | 4.97× | PASS |
| li x orders x customer: c_custkey | o_orderdate < DATE '1995-03-15' | 49% | topk | 10 | 115.6 | 22.9 | 5.04× | PASS |
| li x orders x customer: c_nationkey | o_orderdate >= DATE '1998-06-01' | 3% | plain | 25 | 36.1 | 12.2 | 2.95× | PASS |
| li x orders x customer: c_nationkey | o_orderdate >= DATE '1998-06-01' | 3% | having | 1 | 35.8 | 12.4 | 2.89× | PASS |
| li x orders x customer: c_nationkey | o_orderdate >= DATE '1998-06-01' | 3% | topk | 10 | 36.4 | 12.2 | 2.99× | PASS |
| li x orders x customer: c_custkey | o_orderdate >= DATE '1998-06-01' | 3% | plain | 319607 | 205.8 | 181.0 | 1.14× | PASS |
| li x orders x customer: c_custkey | o_orderdate >= DATE '1998-06-01' | 3% | having | 3161 | 42.4 | 14.5 | 2.92× | PASS |
| li x orders x customer: c_custkey | o_orderdate >= DATE '1998-06-01' | 3% | topk | 10 | 39.1 | 15.4 | 2.54× | PASS |
| li x orders x customer: c_nationkey | l_discount < 0.01 | 9% | plain | 25 | 55.1 | 14.6 | 3.78× | PASS |
| li x orders x customer: c_nationkey | l_discount < 0.01 | 9% | having | 1 | 55.2 | 14.8 | 3.73× | PASS |
| li x orders x customer: c_nationkey | l_discount < 0.01 | 9% | topk | 10 | 55.3 | 14.8 | 3.75× | PASS |
| li x orders x customer: c_custkey | l_discount < 0.01 | 9% | plain | 975125 | 590.6 | 527.1 | 1.12× | PASS |
| li x orders x customer: c_custkey | l_discount < 0.01 | 9% | having | 9689 | 76.6 | 19.5 | 3.92× | PASS |
| li x orders x customer: c_custkey | l_discount < 0.01 | 9% | topk | 10 | 72.8 | 18.3 | 3.98× | PASS |
| li x part: p_brand | — | 100% | plain | 25 | 131.9 | 30.5 | 4.33× | PASS |
| li x part: p_brand | — | 100% | having | 1 | 130.2 | 30.9 | 4.21× | PASS |
| li x part: p_brand | — | 100% | topk | 10 | 129.9 | 30.5 | 4.26× | PASS |
| li x part: p_size | — | 100% | plain | 50 | 89.6 | 24.5 | 3.65× | PASS |
| li x part: p_size | — | 100% | having | 1 | 87.2 | 24.9 | 3.50× | PASS |
| li x part: p_size | — | 100% | topk | 10 | 87.7 | 24.6 | 3.57× | PASS |
| li x part: p_brand | l_discount < 0.01 | 9% | plain | 25 | 32.4 | 15.3 | 2.13× | PASS |
| li x part: p_brand | l_discount < 0.01 | 9% | having | 1 | 33.4 | 15.3 | 2.18× | PASS |
| li x part: p_brand | l_discount < 0.01 | 9% | topk | 10 | 32.6 | 15.1 | 2.16× | PASS |
| li x part: p_size | l_discount < 0.01 | 9% | plain | 50 | 28.5 | 16.3 | 1.75× | PASS |
| li x part: p_size | l_discount < 0.01 | 9% | having | 1 | 28.1 | 16.7 | 1.68× | PASS |
| li x part: p_size | l_discount < 0.01 | 9% | topk | 10 | 27.8 | 16.3 | 1.70× | PASS |
| li x part: p_brand | p_size <= 10 AND l_linenumber <= 3 | 13% | plain | 25 | 57.1 | 20.0 | 2.86× | PASS |
| li x part: p_brand | p_size <= 10 AND l_linenumber <= 3 | 13% | having | 1 | 55.8 | 20.4 | 2.73× | PASS |
| li x part: p_brand | p_size <= 10 AND l_linenumber <= 3 | 13% | topk | 10 | 55.9 | 19.8 | 2.82× | PASS |
| li x part: p_size | p_size <= 10 AND l_linenumber <= 3 | 13% | plain | 10 | 51.9 | 15.6 | 3.32× | PASS |
| li x part: p_size | p_size <= 10 AND l_linenumber <= 3 | 13% | having | 1 | 51.1 | 15.6 | 3.29× | PASS |
| li x part: p_size | p_size <= 10 AND l_linenumber <= 3 | 13% | topk | 10 | 50.6 | 15.4 | 3.29× | PASS |

Reading: native has to run the join whatever comes out of it, so the few-group
shapes that lose on a single table win here; the plain form returning ~1M
groups is bound by moving the rows out on both sides (1.08–1.28x). The one
losing shape found (SF1, plain form, 32K groups under a 3% dimension filter,
0.92–0.99x) is declined by `_thresholds.py`.

## v0.7 several payload columns per statement — Metal, TPC-H SF1 (2026-09-17)

`scripts/transparent_gate.py --payloads 3`: every statement aggregates three
payload columns (`sum(l_quantity), sum(l_extendedprice), max(l_tax)`), single
table and over key joins, through `gpudb.connect()` with the shipping
thresholds. Apple M4 Max, N=5, statement vs statement, rows identical to
native on every rewritten line. The fused Metal operator computes the WHERE
mask and the grouping once and repeats only the reduce per payload
(docs/TRANSPARENT_DESIGN.md §4.9); before the fusion the same sweep had 20
rows at 0.56–0.99x.

| key | WHERE | selectivity | form | rows out | native ms | transparent ms | ratio | result |
|---|---|---|---|---|---|---|---|---|
| l_linenumber | — | 100% | plain | 7 | 3.3 | — | — | declined (threshold) |
| l_linenumber | — | 100% | having | 1 | 2.9 | — | — | declined (threshold) |
| l_linenumber | — | 100% | topk | 7 | 2.8 | — | — | declined (threshold) |
| l_suppkey | — | 100% | plain | 10000 | 21.2 | 17.9 | 1.19× | PASS |
| l_suppkey | — | 100% | having | 100 | 7.4 | 4.5 | 1.65× | PASS |
| l_suppkey | — | 100% | topk | 10 | 7.4 | — | — | declined (threshold) |
| l_partkey | — | 100% | plain | 200000 | 278.5 | — | — | declined (threshold) |
| l_partkey | — | 100% | having | 1981 | 22.6 | 7.1 | 3.18× | PASS |
| l_partkey | — | 100% | topk | 10 | 20.5 | 7.2 | 2.86× | PASS |
| l_orderkey | — | 100% | plain | 1500000 | 1914.8 | — | — | declined (threshold) |
| l_orderkey | — | 100% | having | 14816 | 32.3 | 26.9 | 1.20× | PASS |
| l_orderkey | — | 100% | topk | 10 | 13.9 | 9.6 | 1.44× | PASS |
| l_linenumber | l_discount < 0.01 | 9% | plain | 7 | 2.1 | — | — | declined (threshold) |
| l_linenumber | l_discount < 0.01 | 9% | having | 1 | 2.0 | — | — | declined (threshold) |
| l_linenumber | l_discount < 0.01 | 9% | topk | 7 | 2.0 | — | — | declined (threshold) |
| l_suppkey | l_discount < 0.01 | 9% | plain | 10000 | 16.2 | — | — | declined (threshold) |
| l_suppkey | l_discount < 0.01 | 9% | having | 99 | 3.3 | — | — | declined (threshold) |
| l_suppkey | l_discount < 0.01 | 9% | topk | 10 | 3.2 | — | — | declined (threshold) |
| l_partkey | l_discount < 0.01 | 9% | plain | 186984 | 241.4 | — | — | declined (threshold) |
| l_partkey | l_discount < 0.01 | 9% | having | 1808 | 6.6 | — | — | declined (threshold) |
| l_partkey | l_discount < 0.01 | 9% | topk | 10 | 4.5 | — | — | declined (threshold) |
| l_orderkey | l_discount < 0.01 | 9% | plain | 455920 | 574.3 | — | — | declined (threshold) |
| l_orderkey | l_discount < 0.01 | 9% | having | 4547 | 10.2 | — | — | declined (threshold) |
| l_orderkey | l_discount < 0.01 | 9% | topk | 10 | 4.6 | — | — | declined (threshold) |
| l_linenumber | l_linenumber = 1 | 25% | plain | 1 | 2.0 | — | — | declined (threshold) |
| l_linenumber | l_linenumber = 1 | 25% | having | 0 | 2.0 | — | — | declined (threshold) |
| l_linenumber | l_linenumber = 1 | 25% | topk | 1 | 2.0 | — | — | declined (threshold) |
| l_suppkey | l_linenumber = 1 | 25% | plain | 10000 | 17.2 | — | — | declined (threshold) |
| l_suppkey | l_linenumber = 1 | 25% | having | 99 | 4.3 | — | — | declined (threshold) |
| l_suppkey | l_linenumber = 1 | 25% | topk | 10 | 4.1 | — | — | declined (threshold) |
| l_partkey | l_linenumber = 1 | 25% | plain | 199893 | 263.8 | — | — | declined (threshold) |
| l_partkey | l_linenumber = 1 | 25% | having | 1952 | 10.2 | 6.0 | 1.70× | PASS |
| l_partkey | l_linenumber = 1 | 25% | topk | 10 | 8.1 | — | — | declined (threshold) |
| l_orderkey | l_linenumber = 1 | 25% | plain | 1500000 | 1878.5 | — | — | declined (threshold) |
| l_orderkey | l_linenumber = 1 | 25% | having | 0 | 9.2 | 4.8 | 1.92× | PASS |
| l_orderkey | l_linenumber = 1 | 25% | topk | 10 | 9.3 | — | — | declined (threshold) |
| l_linenumber | l_linenumber <= 3 | 64% | plain | 3 | 3.1 | — | — | declined (threshold) |
| l_linenumber | l_linenumber <= 3 | 64% | having | 1 | 2.7 | — | — | declined (threshold) |
| l_linenumber | l_linenumber <= 3 | 64% | topk | 3 | 2.8 | — | — | declined (threshold) |
| l_suppkey | l_linenumber <= 3 | 64% | plain | 10000 | 19.2 | — | — | declined (threshold) |
| l_suppkey | l_linenumber <= 3 | 64% | having | 100 | 6.0 | 4.7 | 1.27× | PASS |
| l_suppkey | l_linenumber <= 3 | 64% | topk | 10 | 5.8 | — | — | declined (threshold) |
| l_partkey | l_linenumber <= 3 | 64% | plain | 200000 | 276.1 | — | — | declined (threshold) |
| l_partkey | l_linenumber <= 3 | 64% | having | 1994 | 16.9 | 8.2 | 2.06× | PASS |
| l_partkey | l_linenumber <= 3 | 64% | topk | 10 | 14.4 | — | — | declined (threshold) |
| l_orderkey | l_linenumber <= 3 | 64% | plain | 1500000 | 1932.7 | — | — | declined (threshold) |
| l_orderkey | l_linenumber <= 3 | 64% | having | 13299 | 28.1 | 26.5 | 1.06× | PASS |
| l_orderkey | l_linenumber <= 3 | 64% | topk | 10 | 11.8 | — | — | declined (threshold) |
| l_linenumber | l_discount <= 0.09 | 91% | plain | 7 | 3.5 | — | — | declined (threshold) |
| l_linenumber | l_discount <= 0.09 | 91% | having | 1 | 3.2 | — | — | declined (threshold) |
| l_linenumber | l_discount <= 0.09 | 91% | topk | 7 | 3.3 | — | — | declined (threshold) |
| l_suppkey | l_discount <= 0.09 | 91% | plain | 10000 | 20.2 | — | — | declined (threshold) |
| l_suppkey | l_discount <= 0.09 | 91% | having | 100 | 7.0 | 5.3 | 1.32× | PASS |
| l_suppkey | l_discount <= 0.09 | 91% | topk | 10 | 6.9 | — | — | declined (threshold) |
| l_partkey | l_discount <= 0.09 | 91% | plain | 200000 | 276.2 | — | — | declined (threshold) |
| l_partkey | l_discount <= 0.09 | 91% | having | 1985 | 21.1 | 8.8 | 2.41× | PASS |
| l_partkey | l_discount <= 0.09 | 91% | topk | 10 | 18.7 | 8.6 | 2.18× | PASS |
| l_orderkey | l_discount <= 0.09 | 91% | plain | 1478717 | 1927.7 | — | — | declined (threshold) |
| l_orderkey | l_discount <= 0.09 | 91% | having | 14405 | 31.3 | 29.1 | 1.08× | PASS |
| l_orderkey | l_discount <= 0.09 | 91% | topk | 10 | 13.8 | 12.0 | 1.15× | PASS |
| l_linenumber | l_discount BETWEEN 0.02 AND 0.08 AND l_linenumber <> 4 | 55% | plain | 6 | 3.2 | — | — | declined (threshold) |
| l_linenumber | l_discount BETWEEN 0.02 AND 0.08 AND l_linenumber <> 4 | 55% | having | 1 | 3.0 | — | — | declined (threshold) |
| l_linenumber | l_discount BETWEEN 0.02 AND 0.08 AND l_linenumber <> 4 | 55% | topk | 6 | 3.1 | — | — | declined (threshold) |
| l_suppkey | l_discount BETWEEN 0.02 AND 0.08 AND l_linenumber <> 4 | 55% | plain | 10000 | 19.0 | — | — | declined (threshold) |
| l_suppkey | l_discount BETWEEN 0.02 AND 0.08 AND l_linenumber <> 4 | 55% | having | 100 | 6.0 | 5.3 | 1.13× | PASS |
| l_suppkey | l_discount BETWEEN 0.02 AND 0.08 AND l_linenumber <> 4 | 55% | topk | 10 | 6.0 | — | — | declined (threshold) |
| l_partkey | l_discount BETWEEN 0.02 AND 0.08 AND l_linenumber <> 4 | 55% | plain | 200000 | 274.9 | — | — | declined (threshold) |
| l_partkey | l_discount BETWEEN 0.02 AND 0.08 AND l_linenumber <> 4 | 55% | having | 1986 | 15.5 | 8.7 | 1.79× | PASS |
| l_partkey | l_discount BETWEEN 0.02 AND 0.08 AND l_linenumber <> 4 | 55% | topk | 10 | 13.2 | — | — | declined (threshold) |
| l_orderkey | l_discount BETWEEN 0.02 AND 0.08 AND l_linenumber <> 4 | 55% | plain | 1367799 | 1773.3 | — | — | declined (threshold) |
| l_orderkey | l_discount BETWEEN 0.02 AND 0.08 AND l_linenumber <> 4 | 55% | having | 13644 | 28.7 | 27.5 | 1.04× | PASS |
| l_orderkey | l_discount BETWEEN 0.02 AND 0.08 AND l_linenumber <> 4 | 55% | topk | 10 | 12.2 | — | — | declined (threshold) |
| li x orders: o_custkey | — | 100% | plain | 99996 | 154.3 | — | — | declined (threshold) |
| li x orders: o_custkey | — | 100% | having | 999 | 22.8 | 5.3 | 4.29× | PASS |
| li x orders: o_custkey | — | 100% | topk | 10 | 21.6 | 6.1 | 3.55× | PASS |
| li x orders: o_orderdate | — | 100% | plain | 2406 | 14.9 | 6.6 | 2.28× | PASS |
| li x orders: o_orderdate | — | 100% | having | 25 | 11.1 | 3.1 | 3.58× | PASS |
| li x orders: o_orderdate | — | 100% | topk | 10 | 11.1 | 2.9 | 3.77× | PASS |
| li x orders: l_suppkey | — | 100% | plain | 10000 | 29.6 | 18.5 | 1.60× | PASS |
| li x orders: l_suppkey | — | 100% | having | 100 | 15.6 | 4.4 | 3.51× | PASS |
| li x orders: l_suppkey | — | 100% | topk | 10 | 15.7 | 7.4 | 2.14× | PASS |
| li x orders: o_custkey | o_orderdate < DATE '1995-03-15' | 49% | plain | 99606 | 147.7 | — | — | declined (threshold) |
| li x orders: o_custkey | o_orderdate < DATE '1995-03-15' | 49% | having | 992 | 16.6 | 5.6 | 2.98× | PASS |
| li x orders: o_custkey | o_orderdate < DATE '1995-03-15' | 49% | topk | 10 | 16.2 | 6.6 | 2.47× | PASS |
| li x orders: o_orderdate | o_orderdate < DATE '1995-03-15' | 49% | plain | 1169 | 12.0 | 4.2 | 2.85× | PASS |
| li x orders: o_orderdate | o_orderdate < DATE '1995-03-15' | 49% | having | 12 | 10.2 | 2.2 | 4.56× | PASS |
| li x orders: o_orderdate | o_orderdate < DATE '1995-03-15' | 49% | topk | 10 | 10.2 | 3.8 | 2.71× | PASS |
| li x orders: l_suppkey | o_orderdate < DATE '1995-03-15' | 49% | plain | 10000 | 26.6 | 18.8 | 1.41× | PASS |
| li x orders: l_suppkey | o_orderdate < DATE '1995-03-15' | 49% | having | 100 | 13.2 | 4.2 | 3.16× | PASS |
| li x orders: l_suppkey | o_orderdate < DATE '1995-03-15' | 49% | topk | 10 | 13.0 | 4.1 | 3.22× | PASS |
| li x orders: o_custkey | o_orderdate >= DATE '1998-06-01' | 3% | plain | 31708 | 45.2 | — | — | declined (threshold) |
| li x orders: o_custkey | o_orderdate >= DATE '1998-06-01' | 3% | having | 317 | 5.2 | 3.0 | 1.74× | PASS |
| li x orders: o_custkey | o_orderdate >= DATE '1998-06-01' | 3% | topk | 10 | 4.8 | 3.3 | 1.45× | PASS |
| li x orders: o_orderdate | o_orderdate >= DATE '1998-06-01' | 3% | plain | 63 | 4.0 | 1.6 | 2.41× | PASS |
| li x orders: o_orderdate | o_orderdate >= DATE '1998-06-01' | 3% | having | 1 | 3.9 | 1.9 | 2.08× | PASS |
| li x orders: o_orderdate | o_orderdate >= DATE '1998-06-01' | 3% | topk | 10 | 3.9 | 1.5 | 2.54× | PASS |
| li x orders: l_suppkey | o_orderdate >= DATE '1998-06-01' | 3% | plain | 10000 | 18.0 | 16.0 | 1.12× | PASS |
| li x orders: l_suppkey | o_orderdate >= DATE '1998-06-01' | 3% | having | 98 | 5.2 | 2.8 | 1.86× | PASS |
| li x orders: l_suppkey | o_orderdate >= DATE '1998-06-01' | 3% | topk | 10 | 5.0 | 2.6 | 1.94× | PASS |
| li x orders: o_custkey | l_discount < 0.01 | 9% | plain | 97490 | 138.3 | — | — | declined (threshold) |
| li x orders: o_custkey | l_discount < 0.01 | 9% | having | 962 | 11.7 | 4.6 | 2.57× | PASS |
| li x orders: o_custkey | l_discount < 0.01 | 9% | topk | 10 | 10.6 | 5.5 | 1.91× | PASS |
| li x orders: o_orderdate | l_discount < 0.01 | 9% | plain | 2406 | 11.2 | 6.2 | 1.82× | PASS |
| li x orders: o_orderdate | l_discount < 0.01 | 9% | having | 25 | 8.2 | 2.7 | 3.02× | PASS |
| li x orders: o_orderdate | l_discount < 0.01 | 9% | topk | 10 | 8.7 | 2.5 | 3.49× | PASS |
| li x orders: l_suppkey | l_discount < 0.01 | 9% | plain | 10000 | 23.1 | 17.7 | 1.30× | PASS |
| li x orders: l_suppkey | l_discount < 0.01 | 9% | having | 99 | 10.2 | 3.0 | 3.45× | PASS |
| li x orders: l_suppkey | l_discount < 0.01 | 9% | topk | 10 | 10.1 | 2.7 | 3.74× | PASS |
| li x orders x customer: c_nationkey | — | 100% | plain | 25 | 13.6 | 5.9 | 2.30× | PASS |
| li x orders x customer: c_nationkey | — | 100% | having | 1 | 13.1 | 6.4 | 2.04× | PASS |
| li x orders x customer: c_nationkey | — | 100% | topk | 10 | 13.0 | 5.9 | 2.23× | PASS |
| li x orders x customer: c_custkey | — | 100% | plain | 99996 | 158.0 | — | — | declined (threshold) |
| li x orders x customer: c_custkey | — | 100% | having | 999 | 24.3 | 5.1 | 4.76× | PASS |
| li x orders x customer: c_custkey | — | 100% | topk | 10 | 23.0 | 6.1 | 3.75× | PASS |
| li x orders x customer: c_nationkey | o_orderdate < DATE '1995-03-15' | 49% | plain | 25 | 12.4 | 4.0 | 3.09× | PASS |
| li x orders x customer: c_nationkey | o_orderdate < DATE '1995-03-15' | 49% | having | 1 | 11.9 | 4.6 | 2.58× | PASS |
| li x orders x customer: c_nationkey | o_orderdate < DATE '1995-03-15' | 49% | topk | 10 | 11.9 | 4.4 | 2.70× | PASS |
| li x orders x customer: c_custkey | o_orderdate < DATE '1995-03-15' | 49% | plain | 99606 | 151.5 | — | — | declined (threshold) |
| li x orders x customer: c_custkey | o_orderdate < DATE '1995-03-15' | 49% | having | 992 | 18.8 | 5.5 | 3.42× | PASS |
| li x orders x customer: c_custkey | o_orderdate < DATE '1995-03-15' | 49% | topk | 10 | 17.6 | 5.9 | 2.95× | PASS |
| li x orders x customer: c_nationkey | o_orderdate >= DATE '1998-06-01' | 3% | plain | 25 | 5.7 | 5.1 | 1.11× | PASS |
| li x orders x customer: c_nationkey | o_orderdate >= DATE '1998-06-01' | 3% | having | 1 | 5.7 | 2.6 | 2.23× | PASS |
| li x orders x customer: c_nationkey | o_orderdate >= DATE '1998-06-01' | 3% | topk | 10 | 5.7 | 5.3 | 1.09× | PASS |
| li x orders x customer: c_custkey | o_orderdate >= DATE '1998-06-01' | 3% | plain | 31708 | 46.9 | — | — | declined (threshold) |
| li x orders x customer: c_custkey | o_orderdate >= DATE '1998-06-01' | 3% | having | 317 | 6.5 | 3.1 | 2.10× | PASS |
| li x orders x customer: c_custkey | o_orderdate >= DATE '1998-06-01' | 3% | topk | 10 | 6.3 | 3.4 | 1.87× | PASS |
| li x orders x customer: c_nationkey | l_discount < 0.01 | 9% | plain | 25 | 9.2 | 2.6 | 3.55× | PASS |
| li x orders x customer: c_nationkey | l_discount < 0.01 | 9% | having | 1 | 9.1 | 5.1 | 1.79× | PASS |
| li x orders x customer: c_nationkey | l_discount < 0.01 | 9% | topk | 10 | 9.4 | 2.6 | 3.64× | PASS |
...
answer with ONE row-order pass over it — the whole `WHERE` per row, every
payload folded into `acc[gid]` — instead of masking the rows, finding the run
starts of the sorted keys and gathering each payload through the permutation.

**Superseded for its numbers, kept for its shape.** This section sweeps GROUPS
at one row count, 60M. Sweeping ROWS as well found the direct path slower below
about 6M rows and sent four changes through the dispatch (grid sizing, replica
sizing twice, cached per-call buffers), so the kernel times below are not the
shipped code's — the section after this one is, and its table covers 60M rows
too. What survives here is the shape: which group counts the path can serve at
all, and why it declines where it does.

Apple M4 Max, `data/tpch_sf10/tpch.duckdb` (59,986,052 `lineitem` rows), the
Python wrapper with `thresholds=False, residency="eager"` so every shape is
rewritten, `SET threads TO 1` on the raw connection (the two modes of §9.1 stay
out of it), warm, minimum of 10, kernel time from `gpu_last_stats()`.
`GPUDB_METAL_GROUPBY_EXACT_PATH=direct` and `=sort` in separate processes; keys
are `l_orderkey % N` (TPC-H order keys are sparse, so that yields N/4 distinct
values) and `l_suppkey % N` (dense, N distinct); payloads are 1, 3 or 5 `sum()`
columns; the WHERE is 0, 1 or 5 conjunctive terms.

| distinct keys | payloads | WHERE terms | direct ms | sort ms | ratio |
|---|---|---|---|---|---|
| 2 | 1 | 0 | 3.27 | 8.77 | 2.68x |
| 2 | 1 | 1 | 4.16 | 16.08 | 3.87x |
| 2 | 1 | 5 | 8.87 | 28.79 | 3.25x |
| 2 | 3 | 0 | 6.31 | 13.70 | 2.17x |
| 2 | 3 | 1 | 7.84 | 23.95 | 3.05x |
| 2 | 3 | 5 | 11.65 | 35.41 | 3.04x |
| 2 | 5 | 0 | 9.95 | 18.28 | 1.84x |
| 2 | 5 | 1 | 12.35 | 31.61 | 2.56x |
| 2 | 5 | 5 | 15.01 | 42.08 | 2.80x |
| 4 | 1 | 0 | 3.49 | 9.64 | 2.76x |
| 4 | 1 | 1 | 4.36 | 16.89 | 3.87x |
| 4 | 1 | 5 | 9.29 | 29.61 | 3.19x |
| 4 | 3 | 0 | 6.53 | 15.16 | 2.32x |
| 4 | 3 | 1 | 8.20 | 24.66 | 3.01x |
| 4 | 3 | 5 | 12.27 | 36.51 | 2.98x |
| 4 | 5 | 0 | 10.75 | 19.99 | 1.86x |
| 4 | 5 | 1 | 13.72 | 32.41 | 2.36x |
| 4 | 5 | 5 | 16.91 | 43.31 | 2.56x |
| 7 | 1 | 0 | 3.67 | 10.28 | 2.80x |
| 7 | 1 | 1 | 4.56 | 17.47 | 3.83x |
| 7 | 1 | 5 | 9.69 | 29.99 | 3.10x |
| 7 | 3 | 0 | 6.85 | 16.39 | 2.39x |
| 7 | 3 | 1 | 8.81 | 26.17 | 2.97x |
| 7 | 3 | 5 | 13.16 | 38.07 | 2.89x |
| 7 | 5 | 0 | 12.93 | 21.79 | 1.68x |
| 7 | 5 | 1 | 14.96 | 34.36 | 2.30x |
| 7 | 5 | 5 | 19.29 | 45.69 | 2.37x |
| 25 | 1 | 0 | 4.57 | 10.21 | 2.24x |
| 25 | 1 | 1 | 5.78 | 19.36 | 3.35x |
| 25 | 1 | 5 | 11.68 | 31.36 | 2.69x |
| 25 | 3 | 0 | 9.28 | 17.72 | 1.91x |
| 25 | 3 | 1 | 10.93 | 31.92 | 2.92x |
| 25 | 3 | 5 | 15.89 | 42.91 | 2.70x |
| 25 | 5 | 0 | 11.30 | 24.78 | 2.19x |
| 25 | 5 | 1 | 14.39 | 43.94 | 3.05x |
| 25 | 5 | 5 | 18.26 | 54.00 | 2.96x |
| 50 | 1 | 0 | 4.67 | 10.27 | 2.20x |
| 50 | 1 | 1 | 5.86 | 19.60 | 3.35x |
| 50 | 1 | 5 | 11.80 | 31.61 | 2.68x |
| 50 | 3 | 0 | 9.19 | 17.67 | 1.92x |
| 50 | 3 | 1 | 10.99 | 32.58 | 2.96x |
| 50 | 3 | 5 | 15.92 | 42.94 | 2.70x |
| 50 | 5 | 0 | 11.55 | 24.01 | 2.08x |
| 50 | 5 | 1 | 14.76 | 44.80 | 3.04x |
| 50 | 5 | 5 | 18.65 | 54.24 | 2.91x |
| 64 | 1 | 0 | 5.53 | 10.42 | 1.88x |
| 64 | 1 | 1 | 7.31 | 19.45 | 2.66x |
| 64 | 1 | 5 | 13.51 | 31.53 | 2.33x |
| 64 | 3 | 0 | 6.68 | 16.94 | 2.54x |
| 64 | 3 | 1 | 9.01 | 31.89 | 3.54x |
| 64 | 3 | 5 | 13.63 | 42.37 | 3.11x |
| 64 | 5 | 0 | 10.85 | 23.25 | 2.14x |
| 64 | 5 | 1 | 13.68 | 43.43 | 3.18x |
| 64 | 5 | 5 | 17.15 | 52.58 | 3.07x |
| 128 | 1 | 0 | 5.73 | 10.09 | 1.76x |
| 128 | 1 | 1 | 7.51 | 19.15 | 2.55x |
| 128 | 1 | 5 | 13.76 | 31.23 | 2.27x |
| 128 | 3 | 0 | 6.90 | 16.22 | 2.35x |
| 128 | 3 | 1 | 9.11 | 30.56 | 3.35x |
| 128 | 3 | 5 | 13.85 | 41.23 | 2.98x |
| 128 | 5 | 0 | 9.73 | 21.66 | 2.23x |
| 128 | 5 | 1 | 12.53 | 41.54 | 3.32x |
| 128 | 5 | 5 | 15.82 | 50.67 | 3.20x |
| 256 | 1 | 0 | 5.98 | 9.88 | 1.65x |
| 256 | 1 | 1 | 7.78 | 18.66 | 2.40x |
| 256 | 1 | 5 | 14.01 | 30.74 | 2.19x |
| 256 | 3 | 0 | 5.42 | 15.39 | 2.84x |
| 256 | 3 | 1 | 7.48 | 28.35 | 3.79x |
| 256 | 3 | 5 | 12.21 | 39.17 | 3.21x |
| 256 | 5 | 0 | 20.11 | 19.96 | 0.99x |
| 256 | 5 | 1 | 37.19 | 37.00 | 0.99x |
| 256 | 5 | 5 | 46.97 | 46.85 | 1.00x |
| 300 | 1 | 0 | 4.85 | 16.75 | 3.46x |
| 300 | 1 | 1 | 5.82 | 32.44 | 5.58x |
| 300 | 1 | 5 | 11.93 | 41.02 | 3.44x |
| 300 | 3 | 0 | 6.31 | 34.77 | 5.51x |
| 300 | 3 | 1 | 7.75 | 66.45 | 8.57x |
| 300 | 3 | 5 | 11.94 | 68.26 | 5.72x |
| 300 | 5 | 0 | 50.55 | 50.40 | 1.00x |
| 300 | 5 | 1 | 100.62 | 99.56 | 0.99x |
| 300 | 5 | 5 | 96.91 | 95.74 | 0.99x |
| 512 | 1 | 0 | 5.16 | 16.93 | 3.28x |
| 512 | 1 | 1 | 6.90 | 32.69 | 4.74x |
| 512 | 1 | 5 | 13.52 | 41.16 | 3.04x |
| 512 | 3 | 0 | 35.23 | 35.14 | 1.00x |
| 512 | 3 | 1 | 68.35 | 68.01 | 1.00x |
| 512 | 3 | 5 | 70.05 | 71.48 | 1.02x |
| 512 | 5 | 0 | 51.76 | 52.38 | 1.01x |
| 512 | 5 | 1 | 102.45 | 105.00 | 1.02x |
| 512 | 5 | 5 | 98.60 | 100.52 | 1.02x |
| 513 | 1 | 0 | 17.02 | 17.19 | 1.01x |
| 513 | 1 | 1 | 32.63 | 33.32 | 1.02x |
| 513 | 1 | 5 | 41.72 | 42.45 | 1.02x |
| 513 | 3 | 0 | 35.11 | 36.05 | 1.03x |
| 513 | 3 | 1 | 68.53 | 70.09 | 1.02x |
| 513 | 3 | 5 | 69.89 | 71.91 | 1.03x |
| 513 | 5 | 0 | 51.35 | 52.89 | 1.03x |
| 513 | 5 | 1 | 102.88 | 106.15 | 1.03x |
| 513 | 5 | 5 | 98.79 | 101.67 | 1.03x |
| 700 | 1 | 0 | 17.12 | 17.21 | 1.01x |
| 700 | 1 | 1 | 33.20 | 34.04 | 1.03x |
| 700 | 1 | 5 | 41.25 | 42.91 | 1.04x |
| 700 | 3 | 0 | 35.38 | 36.50 | 1.03x |
| 700 | 3 | 1 | 69.35 | 70.79 | 1.02x |
| 700 | 3 | 5 | 70.95 | 72.89 | 1.03x |
| 700 | 5 | 0 | 52.38 | 53.59 | 1.02x |
| 700 | 5 | 1 | 104.02 | 107.30 | 1.03x |
| 700 | 5 | 5 | 99.31 | 102.52 | 1.03x |
| 2435 | 1 | 0 | 16.45 | 16.55 | 1.01x |
| 2435 | 1 | 1 | 16.24 | 16.20 | 1.00x |
| 2435 | 1 | 5 | 37.16 | 37.06 | 1.00x |
| 2435 | 3 | 0 | 33.33 | 33.46 | 1.00x |
| 2435 | 3 | 1 | 33.07 | 32.98 | 1.00x |
| 2435 | 3 | 5 | 64.65 | 64.23 | 0.99x |
| 2435 | 5 | 0 | 48.22 | 48.16 | 1.00x |
| 2435 | 5 | 1 | 47.90 | 47.55 | 0.99x |
| 2435 | 5 | 5 | 91.70 | 91.89 | 1.00x |
| 5000 | 1 | 0 | 9.69 | 9.69 | 1.00x |
| 5000 | 1 | 1 | 18.09 | 18.08 | 1.00x |
| 5000 | 1 | 5 | 30.34 | 30.12 | 0.99x |
| 5000 | 3 | 0 | 14.43 | 14.44 | 1.00x |
| 5000 | 3 | 1 | 25.96 | 25.91 | 1.00x |
| 5000 | 3 | 5 | 36.96 | 36.74 | 0.99x |
| 5000 | 5 | 0 | 18.54 | 18.62 | 1.00x |
| 5000 | 5 | 1 | 33.59 | 33.50 | 1.00x |
| 5000 | 5 | 5 | 43.30 | 43.30 | 1.00x |
| 100000 | 1 | 0 | 16.91 | 17.02 | 1.01x |
| 100000 | 1 | 1 | 33.63 | 33.81 | 1.01x |
| 100000 | 1 | 5 | 42.07 | 42.91 | 1.02x |
| 100000 | 3 | 0 | 34.41 | 34.78 | 1.01x |
| 100000 | 3 | 1 | 70.17 | 70.87 | 1.01x |
| 100000 | 3 | 5 | 71.91 | 72.19 | 1.00x |
| 100000 | 5 | 0 | 50.73 | 50.69 | 1.00x |
| 100000 | 5 | 1 | 105.58 | 106.75 | 1.01x |
| 100000 | 5 | 5 | 100.49 | 101.76 | 1.01x |

**What the table says.** 135 cells, of which the direct path serves 78 and
declines 57. It wins on every one of the 78 — 1.65× to 8.57×, never below 1.6×
— and where it declines it costs nothing: 0.99× to 1.04×, which is the same
sort path on both sides and the measurement's noise. The 57 declines are not a
band above a group count: at 256 groups the 5-payload cell declines while its
1- and 3-payload neighbours win, because the slab holds 247 groups at five
payloads and 1097 at one.

At 60M rows it declines for two reasons, both hard limits rather than a tuning
choice (the row-count rule of the next section is the third, and it is a tuning
choice, measured):

- **the group-id lane** is built up to `GPUDB_METAL_DIRECT_MAX_GROUPS` distinct
  values (512 by default) and no further, so a key with more takes the sort
  path and is never asked again;
- **the threadgroup slab** holds `n_groups × (6 × payloads + 1)` 32-bit words
  and a threadgroup may have 30 KiB of them, so 512 groups fit with one payload
  (3.28× here), 404 with three and 247 with five. Past that the call declines —
  300 groups × 5 payloads, 512 × 3 and 512 × 5 are the 1.00× rows in the table.

**Where the accumulators live** was the whole design. The first version kept
them per thread, as the global aggregate (§4.12) does with its one group. That
is the fastest thing there is for a handful of slots and falls off a cliff
after: at SF10, 4.6 ms at 2 groups × 1 payload, 23 ms at 4 × 3, **106 ms at
4 × 5 and 215 ms at 25 × 3** — 256 threads times the slots is the working set
and no cache holds it. The threadgroup slab replaced it everywhere: 6.5 ms at
4 × 3, 10.8 at 4 × 5, 9.3 at 25 × 3, and 3.3 ms at 2 × 1 where the per-thread
version measured 4.6. The thread-private kernel is kept only for a `min` /
`max` over a payload lane wider than 4 bytes, which the slab's 32-bit atomics
cannot hold exactly (`GPUDB_METAL_DIRECT_THREAD_SLOTS`, default 0).

**The id lane itself**, built once per column inside `prepare()`
(`GPUDB_METAL_TRACE_EXACT=1`, 59,986,052 rows): a run-start count over the sort
cache, a fill of the NULL-key id and a scatter of the run index to row order
through the permutation. It costs one byte a row while the ids fit (60.0 MB at
SF10) and two above 255 (120.0 MB), plus the distinct keys at the key's width,
and 3.76–3.94 ms to build at 60M rows and one byte.

**TPC-H at SF10**, `scripts/tpch_coverage.py --db data/tpch_sf10/tpch.duckdb`
with `GPUDB_MEMORY_BUDGET_MB=200000`, N=5, thresholds on, the same build with
`GPUDB_METAL_GROUPBY_EXACT_PATH=sort` (the algorithm on `main`) against the
default. 17 of 22 on the device, every row identical to native, on both. The
native column is the default run's; the sort run measured native within 15% of
it on every query (Q6 is the outlier at 14.5 against 16.7 ms, the rest under
7%):

| query | native ms | sort ms | direct/auto ms | auto ÷ sort |
|---|---|---|---|---|
| Q1 | 108.2 | 36.6 | 14.6 | 2.50× |
| Q3 | 45.5 | 21.4 | 21.8 | 0.98× |
| Q4 | 44.6 | 5.1 | 3.5 | 1.46× |
| Q5 | 50.0 | 3.7 | 1.8 | 2.03× |
| Q6 | 16.9 | 6.1 | 6.2 | 0.98× |
| Q7 | 50.0 | 19.4 | 20.5 | 0.95× |
| Q8 | 69.6 | 21.5 | 8.2 | 2.61× |
| Q9 | 156.5 | 13.8 | 5.9 | 2.33× |
| Q10 | 84.5 | 21.6 | 21.8 | 0.99× |
| Q11 | 10.3 | 7.0 | 7.1 | 0.99× |
| Q12 | 41.4 | 24.8 | 10.8 | 2.31× |
| Q14 | 30.9 | 4.5 | 4.7 | 0.98× |
| Q17 | 53.1 | 3.3 | 3.6 | 0.90× |
| Q18 | 108.6 | 11.5 | 11.4 | 1.01× |
| Q19 | 63.2 | 4.4 | 4.4 | 1.00× |
| Q21 | 163.6 | 33.0 | 32.8 | 1.00× |
| Q22 | 26.7 | 2.1 | 1.8 | 1.19× |

Medians of two runs each, on the final code. **The noise band is the sort path
measured against itself**: two runs of identical code give a median spread of
1.007 per query and a worst of 1.867.

Which algorithm each query takes was read back from `gpu_last_stats()` rather
than inferred: **Q1, Q4, Q5, Q8, Q9, Q12 and Q22 take the direct path, and every
one of them improves** — 2.50×, 1.46×, 2.03×, 2.61×, 2.33×, 2.31×, 1.19×. Q3,
Q7, Q10, Q18 and Q21 take the sort path, and Q6, Q11, Q14, Q17 and Q19 have no
exact GROUP BY at all (§4.12, the global aggregate). Those ten run byte-identical
code on both sides, so their 0.90–1.01 is the instrument; Q17, the lowest at
0.90, is one of them and cannot reach this path.

The two queries the row sweep was chasing are the ones to check: **Q22 went
0.63× before this work to 1.19× after** (its kernel 1.29 → 0.52 ms) and **Q5
0.65× to 2.03×**. At SF1 the same sort-vs-sort comparison has a worst spread of
2.33, which is why the SF10 table is the one that means anything.

**Q1 and Q12 stage by stage**, `GPUDB_METAL_TRACE_EXACT=1` at SF10:

| statement | stage | sort ms | direct ms |
|---|---|---|---|
| Q1 (4 groups, 1 predicate, 5 payloads) | mask/select | 6.35 | — |
| | stage A (run starts) | 3.30 | — |
| | stage B (reduce) | 7.29 | — |
| | extra payloads | 19.24 | — |
| | one direct pass | — | 14.32 |
| | **whole kernel** | **36.19** | **14.32** (2.53×) |
| Q12 (7 groups in the lane, 2 surviving, 4 predicates, 2 payloads) | mask/select | 20.06 | — |
| | stage A (run starts) | 3.57 | — |
| | stage B (reduce) | 0.19 | — |
| | extra payloads | 0.17 | — |
| | one direct pass | — | 9.05 |
| | **whole kernel** | **24.00** | **9.05** (2.65×) |

Q12 is the clearer picture of the two: its `WHERE` is four terms and the sort
path spends 20 of its 24 ms writing a mask byte per row, four times, before it
finds two groups in 0.4 ms. The direct pass evaluates the same conjunction
inside the reduce and never writes the mask at all.

**The gate.** `PYTHONPATH=python python3 scripts/transparent_gate.py
--subqueries --exprs` on this code state, SF1, alone on the machine: 782 rows,
517 PASS, 265 declined by the thresholds, **0 below the bound and 0 differing**,
exit 0. The passing ratios run 1.02× to 54.17×. The bounds are unchanged from
`main` (see `python/gpudb/_thresholds.py` for why), so the row set is the same
one and no shape was newly admitted; what moved is the speed of the shapes that
were already there.

**First-call gap.** A freshly allocated shared scratch buffer costs the GPU
something the first time it touches it, so `prepare()` now sizes and touches the
sort path's two row-sized buffers (the WHERE mask, a byte a row; the run starts,
a u32 a row) while the wrapper's upload is running, and the next query adopts
them. Measured at SF10 on `SELECT l_suppkey, sum(l_extendedprice) FROM lineitem
WHERE l_shipdate <= DATE '1998-09-01' GROUP BY 1` (100K groups, the sort path),
the first call against the minimum of the next ten, `GPUDB_METAL_PREWARM=0` and
`=1`:

| | first kernel ms | warm kernel ms | gap |
|---|---|---|---|
| no prewarm | 35.44 | 34.30 | 1.15 ms |
| prewarm | 35.09 | 34.20 | 0.89 ms |

That is the honest number and it is not the 18 ms the plan expected at SF10: by
the time the first statement runs, the upload has already allocated and written
lane buffers of the same order through the same allocator, so the pages the
scratch needs are not cold any more. The prewarm stays because it costs nothing
(it runs inside an upload that takes 1.6 s) and because a statement that takes
...
whose per-threadgroup setup is invisible at 60M rows is the whole call at 1M.
Sweeping ROWS as well as groups found the direct path slower than the sort path
on **78 of 192 cells** — everything below about 6M rows, and TPC-H Q22 (1.4 ->
3.2 ms) and Q5 (2.2 -> 3.4) with it.

**What the fixed cost was.** Per threadgroup, the slab kernel clears its
accumulator slab and folds it again at the end: `2 x replicas x (n_groups x
(6 x payloads + 1))` words, none of it proportional to rows. The grid was
`pick_grid(rows)` — rows / 256, capped at 4096 — so at 1M rows it started 3906
threadgroups, each clearing and folding up to 30 KiB for 256 rows of work. At
7 groups and 3 payloads that was 2.6 ms of the 2.6 ms call.

**What was removed, in order of what it bought:**

1. **The grid is sized to the row work, not the row count.** `dir_grid` now caps
   the threadgroups so a threadgroup's setup is at most an eighth of the rows it
   then processes (`rows x (1 + 4 x payloads)` work units). At 60M rows nothing
   changes (the cap is still 4096); at 1M rows, 7 groups, 3 payloads it drops to
   190 threadgroups. Slower cells: 78 -> 27.
2. **The replicas come down with it.** A replica costs every threadgroup two
   passes over its slab, so when the grid rule cannot reach 64 threadgroups the
   replica count halves until it can.
3. **The replica cap went UP, from 32 to 256 — one copy per thread.** The cells
   that still lost were 2 and 7 groups at mid row counts, and they were losing
   to *contention*, not setup: with two groups, 256 threads were sharing two
   words. A copy per thread removes it entirely, and few groups is exactly the
   case where a copy is small enough to afford. Slower cells: 27 -> 10, and
   6M rows x 2 groups x 1 payload went 1.85 -> 0.47 ms.
4. **The replicas asked for are the ones wanted, not the ones that fit.** What
   the 256 threads of a threadgroup share is `n_groups x replicas` words, so
   the replicas worth having are those that bring that to about one word a
   thread. Taking the memory maximum instead is what was still starving TPC-H
   Q22 — 25 groups over 1.5M rows got 32 replicas, a 22 KiB slab, one
   threadgroup a core and 83 threadgroups for the whole query. Asking for 16
   made it 167 threadgroups at 11 KiB: Q22's kernel 1.29 -> 0.52 ms and its
   statement 1.53 -> 1.06, against the sort path's 1.7.
5. **The per-call buffers are the operator's.** The lane table, the WHERE
   program, its IN lists and the payload slots were four fresh `MTLBuffer`s on
   every call — a few hundred bytes each, and on a call whose kernel is under a
   millisecond, the call. They are grown once and rewritten.

One thing was tried and **reverted**: cutting the atomics per value from four to
two for lanes stored at 4 bytes or narrower (the top limb of a value that fits
int32 is only its sign, so the negatives can be counted instead) and skipping
the `count(v)` atomic for a lane with no validity bitmap. Correct, and measured
at a **median 1.00x over 192 cells** — the pass is bandwidth-bound on the lane
reads, not atomic-bound. The kernel kept the simpler form.

**What the measurement is worth.** Two identical runs of the sweep differ by
1.04x at the median and 1.44x at p90 on whole-call time, but on KERNEL time the
p90 spread is 3.90x — until the kernel passes 0.5 ms, where it falls to 1.02x at
p90 and 1.43x at worst. So: **cells under 0.5 ms of kernel are not evidence**,
and every comparison below uses the median over runs on both sides, because the
slow mode of §9.1 is a property of the process and hits both paths. One cell
(2.4M rows, 3 groups, 3 payloads, no WHERE) measured 0.42x in two consecutive
runs and 1.11-1.78x in three more; a floor fitted to the first pair would have
been fitted to that.

| rows | groups | sort ÷ direct, all 9 shapes | … the shapes the rule admits | admitted |
|---|---|---|---|---|
| 1,000,000 | 2 | 0.96–0.96× | — | 0 of 9 |
| 1,000,000 | 3 | under 0.5 ms | under 0.5 ms | 3 of 9 |
| 1,000,000 | 4 | under 0.5 ms | under 0.5 ms | 3 of 9 |
| 1,000,000 | 5 | under 0.5 ms | under 0.5 ms | 3 of 9 |
| 1,000,000 | 7 | under 0.5 ms | under 0.5 ms | 3 of 9 |
| 1,000,000 | 25 | under 0.5 ms | under 0.5 ms | 3 of 9 |
| 1,000,000 | 300 | 1.14–1.28× | 1.14–1.14× | 1 of 6 |
| 2,400,000 | 2 | 0.54–2.37× | — | 0 of 9 |
| 2,400,000 | 3 | 1.42–2.37× | 1.42–2.37× | 7 of 9 |
| 2,400,000 | 4 | 1.50–2.57× | 1.50–2.57× | 7 of 9 |
| 2,400,000 | 5 | 0.88–2.21× | 1.53–2.21× | 7 of 9 |
| 2,400,000 | 7 | 1.24–2.56× | 2.15–2.56× | 7 of 9 |
| 2,400,000 | 25 | 0.66–2.88× | 2.37–2.88× | 7 of 9 |
| 2,400,000 | 300 | 2.74–2.75× | 2.74–2.75× | 4 of 6 |
| 6,000,000 | 2 | 0.94–2.15× | — | 0 of 9 |
| 6,000,000 | 3 | 1.15–2.68× | 1.15–2.68× | 9 of 9 |
| 6,000,000 | 4 | 1.02–2.11× | 1.02–2.11× | 9 of 9 |
| 6,000,000 | 5 | 1.12–2.40× | 1.12–2.40× | 9 of 9 |
| 6,000,000 | 7 | 1.35–2.97× | 1.35–2.97× | 9 of 9 |
| 6,000,000 | 25 | 1.52–2.91× | 1.52–2.91× | 9 of 9 |
| 6,000,000 | 300 | 1.59–2.49× | 1.59–2.49× | 6 of 6 |
| 15,000,000 | 2 | 0.95–2.04× | — | 0 of 9 |
| 15,000,000 | 3 | 1.04–2.59× | 1.04–2.59× | 9 of 9 |
| 15,000,000 | 4 | 1.00–1.96× | 1.00–1.96× | 9 of 9 |
| 15,000,000 | 5 | 0.99–2.24× | 0.99–2.24× | 9 of 9 |
| 15,000,000 | 7 | 1.28–2.91× | 1.28–2.91× | 9 of 9 |
| 15,000,000 | 25 | 1.54–3.17× | 1.54–3.17× | 9 of 9 |
| 15,000,000 | 300 | 1.81–3.29× | 1.81–3.29× | 6 of 6 |
| 60,000,000 | 2 | 1.72–3.66× | — | 0 of 9 |
| 60,000,000 | 3 | 1.36–3.58× | 1.36–3.58× | 9 of 9 |
| 60,000,000 | 4 | 1.90–3.77× | 1.90–3.77× | 9 of 9 |
| 60,000,000 | 5 | 1.88–3.75× | 1.88–3.75× | 9 of 9 |
| 60,000,000 | 7 | 1.81–3.94× | 1.81–3.94× | 9 of 9 |
| 60,000,000 | 25 | 2.77–5.25× | 2.77–5.25× | 9 of 9 |
| 60,000,000 | 300 | 3.80–8.39× | 3.80–8.39× | 6 of 6 |

**The rule.** `auto` takes the direct path only when

    groups >= 3   AND   rows x (payloads + WHERE terms) >= 6,000,000

Both halves are needed and neither is a round number picked for looks:

- **groups >= 3**, because with two groups the sort path's reduce is a segmented
  scan of two runs — a sequential read, its best case — while the direct path
  still pays for the id lane. Every remaining loser in the final sweep is a
  2-group cell; at 3 groups and up there are none. 3, 4 and 5 groups were swept
  in their own right so the bound sits where the data puts it and not at the
  next value the first sweep happened to contain — TPC-H Q1 has four groups and
  keeps its 2.5x.
- **rows x (payloads + terms) >= 6M**, because what the direct path saves is one
  gather per payload and one mask pass per term, and below that there is not
  enough of either to pay back reading the id lane. The data also allows 4M
  (0 slower either way); 6M is taken because the cells between them are the
  smallest and noisiest measured, and it costs 2 of 218 usable wins.

Verified over the two final runs of a 315-cell sweep (rows x groups x payloads
1/3/5 x WHERE terms 0/1/3, medians of both runs): of the 208 cells the rule
admits, **179 are above the 0.5 ms floor and 0 of them are slower** than the
sort path on either kernel or whole-call time; the worst is 0.99x, a 15M-row
5-group 5-payload shape that is even. 30 winning cells are given up, all of them
2-group or under 6M work units.
